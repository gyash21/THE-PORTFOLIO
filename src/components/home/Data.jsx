...
const Data = () => {
    return(
        ...
        <div className="home__data">
            <h1 className="home__title">Yash Gupta
            ...
            <p className="home__description">I'm a creative and innovative developer based in Bangalore passionate and dedicated to my work.</p>
